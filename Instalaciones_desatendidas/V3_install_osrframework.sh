...
echo "Para probar la instalación puede utilizar el siguiente comando tal como muestra la documentación oficial"
echo "usufy.py -n i3visio febrezo yrubiosec -p twitter facebook
searchfy.py -q "i3visio"
mailfy.py -n i3visio"
echo "Puedes consultar la documentación oficial en https://github.com/i3visio/osrframework"
echo ""
