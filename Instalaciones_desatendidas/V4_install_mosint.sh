...
depriv bash -c "
cd '$INSTALL_DIR/mosint/v3/cmd/mosint' || { echo 'No se pudo cambiar al directorio $INSTALL_DIR/mosint/v3/cmd/mosint.'; exit 1; }
...
cd '$INSTALL_DIR/mosint/v3/cmd/mosint' || { echo 'No se pudo cambiar al directorio $INSTALL_DIR/mosint/v3/cmd/mosint.'; exit 1; }
source '$VENV_DIR/bin/activate'
# Aquí puedes agregar el archivo requirements.txt si es necesario
